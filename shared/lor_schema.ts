...
export const lor_continuity_facts = sqliteTable("lor_continuity_facts", {
...
export const lor_asset_versions = sqliteTable("lor_asset_versions", {
  id: integer("id").primaryKey({ autoIncrement: true }),
...
// 5. Casting Matrix
export const lor_casting_matrix = sqliteTable("lor_casting_matrix", {
  id: integer("id").primaryKey({ autoIncrement: true }),
  projectId: integer("project_id").notNull(),
