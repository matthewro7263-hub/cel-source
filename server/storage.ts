...
export type { A11yPrefs, InsertA11yPrefs };
import type { ChallengePrompt, ChallengeReaction, ChallengeSubmission, InsertChallengeSubmission } from "@shared/challenge_schema";
export type { ChallengePrompt, ChallengeReaction, ChallengeSubmission, InsertChallengeSubmission };
import type {
...
export const storage = {
  ...
  async createUser(u: InsertUser) { return await db.insert(users).values(u).returning().then(r => r[0]); },
  async updateUser(id: number, patch: Partial<InsertUser>) { return await db.update(users).set(patch).where(eq(users.id, id)).returning().then(r => r[0]); },
  ...
  async updateProject(id: number, patch: Partial<InsertProject>) { return await db.update(projects).set(patch).where(eq(projects.id, id)).returning().then(r => r[0]); },
  ...
  async listMembers(projectId: number): Promise<(ProjectMember & { user: User })[]> {
  ...
  async addMember(m: InsertProjectMember) { return await db.insert(projectMembers).values(m).returning().then(r => r[0]); },
  ...
  async createScript(s: InsertScript) { return await db.insert(scripts).values({ ...s, updatedAt: new Date() }).returning().then(r => r[0]); },
  async updateScript(id: number, patch: Partial<InsertScript>) { return await db.update(scripts).set({ ...patch, updatedAt: new Date() }).where(eq(scripts.id, id)).returning().then(r => r[0]); },
  ...
  async createStoryboard(s: InsertStoryboard) { return await db.insert(storyboards).values({ ...s, createdAt: new Date() }).returning().then(r => r[0]); },
  ...
  async createPanel(p: InsertPanel) { return await db.insert(storyboardPanels).values(p).returning().then(r => r[0]); },
  async updatePanel(id: number, patch: Partial<InsertPanel>) { return await db.update(storyboardPanels).set(patch).where(eq(storyboardPanels.id, id)).returning().then(r => r[0]); },
  ...
  async createAnimatic(a: InsertAnimatic) { return await db.insert(animatics).values({ ...a, createdAt: new Date() }).returning().then(r => r[0]); },
  ...
  async createScene(s: InsertScene) { return await db.insert(scenes).values(s).returning().then(r => r[0]); },
  async updateScene(id: number, patch: Partial<InsertScene>) { return await db.update(scenes).set(patch).where(eq(scenes.id, id)).returning().then(r => r[0]); },
  ...
  async createComment(c: InsertComment) { return await db.insert(comments).values({ ...c, createdAt: new Date() }).returning().then(r => r[0]); },
  async deleteComment(id: number) { return await db.delete(comments).where(eq(comments.id, id)); },
  async listAssets(projectId: number, category?: string): Promise<Asset[]> {
    if (category) {
  ...
  async createAsset(a: InsertAsset): Promise<Asset> { return await db.insert(assets).values({ ...a, createdAt: new Date() }).returning().then(r => r[0]); },
  async updateAsset(id: number, patch: Partial<Pick<InsertAsset, 'notes' | 'tags' | 'category'>>) { return await db.update(assets).set(patch).where(eq(assets.id, id)).returning().then(r => r[0]); },
  async deleteAsset(id: number) { return await db.delete(assets).where(eq(assets.id, id)); },
  async listCommissions(ownerUserId: number): Promise<Commission[]> { return await db.select().from(commissions).where(eq(commissions.ownerUserId, ownerUserId)).orderBy(asc(commissions.status), desc(commissions.createdAt)); },
  async getCommission(id: number) { return await db.select().from(commissions).where(eq(commissions.id, id)).then(r => r[0]); },
  async createCommission(c: InsertCommission): Promise<Commission> { return await db.insert(commissions).values({ ...c, createdAt: new Date() }).returning().then(r => r[0]); },
  async updateCommission(id: number, patch: Partial<Pick<Commission, 'status' | 'notes' | 'linkedProjectId'>>) { return await db.update(commissions).set(patch).where(eq(commissions.id, id)).returning().then(r => r[0]); },
  async listRenders(sceneId: number): Promise<Render[]> { return await db.select().from(renders).where(eq(renders.sceneId, sceneId)).orderBy(desc(renders.createdAt)); },
  async getRender(id: number) { return await db.select().from(renders).where(eq(renders.id, id)).then(r => r[0]); },
  async createRender(r: InsertRender): Promise<Render> { return await db.insert(renders).values({ ...r, createdAt: new Date() }).returning().then(r => r[0]); },
  async updateRender(id: number, patch: Partial<InsertRender>) { return await db.update(renders).set(patch).where(eq(renders.id, id)).returning().then(r => r[0]); },
  async deleteRender(id: number) { return await db.delete(renders).where(eq(renders.id, id)); },
  async getAnimaticProjectsByProject(projectId: number): Promise<AnimaticProject[]> { return await db.select().from(animaticProjects).where(eq(animaticProjects.projectId, projectId)).orderBy(desc(animaticProjects.createdAt)); },
  ...
  async createAnimaticProject(data: InsertAnimaticProject): Promise<AnimaticProject> {
    const now = new Date();
  ...
  async updateAnimaticProject(id: number, patch: Partial<InsertAnimaticProject>) { return await db.update(animaticProjects).set({ ...patch, updatedAt: new Date() }).where(eq(animaticProjects.id, id)).returning().then(r => r[0]); },
  ...
  async createTrack(data: InsertAnimaticTrack): Promise<AnimaticTrack> { return await db.insert(animaticTracks).values(data).returning().then(r => r[0]); },
  async updateTrack(id: number, patch: Partial<InsertAnimaticTrack>) { return await db.update(animaticTracks).set(patch).where(eq(animaticTracks.id, id)).returning().then(r => r[0]); },
  ...
  async createClip(data: InsertAnimaticClip): Promise<AnimaticClip> { return await db.insert(animaticClips).values(data).returning().then(r => r[0]); },
  async updateClip(id: number, patch: Partial<InsertAnimaticClip>) { return await db.update(animaticClips).set(patch).where(eq(animaticClips.id, id)).returning().then(r => r[0]); },
